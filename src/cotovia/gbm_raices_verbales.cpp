...
* \file
* \author giglesia
* \remark Desarrolla los métodos de la clase gbm_raices_verbales.
*/
...
* para un fichero de raíces verbales, a partir del procesado genérico de la clase
* padre.
...
//Nota: esta función sólo tiene sentido si se ejecuta después de "buscar(...)".
